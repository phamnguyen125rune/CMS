...
public class PostMapper {
    ...
    public Post reqUpdateToPost(ReqPostUpdateDTO dto) {
        ...
        post.setMetaDescription(dto.getMetaDescription());
        post.setCanonicalUrl(dto.getCanonicalUrl());
        if (dto.getIsIndexable() != null)
            post.setIsIndexable(dto.getIsIndexable());
        if (dto.getIsFollowable() != null)
            post.setIsFollowable(dto.getIsFollowable());
    ...
    public ResPostDTO postToResPostDTO(Post post, PostCategory category, String authorName, String ogImageUrl) {
        ...
        String finalTitle = post.getMetaTitle() != null && !post.getMetaTitle().isBlank() ? post.getMetaTitle()
                : post.getTitle();
        String finalDesc = post.getMetaDescription() != null && !post.getMetaDescription().isBlank()
        ...
        og.setDescription(
                post.getOgDescription() != null && !post.getOgDescription().isBlank() ? post.getOgDescription()
                        : finalDesc);
    ...
    private String buildJsonLd(Post post, String title, String desc, String categoryName, String authorName,
            String imageUrl) {
        ...
        String pubDate = post.getPublishedAt() != null ? post.getPublishedAt().toString()
