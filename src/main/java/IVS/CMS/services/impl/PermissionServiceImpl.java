...
public class PermissionServiceImpl implements PermissionService {
    ...
    public Permission update(long id, Permission permission) {
        ...
        currentPermission.setResourceCode(permission.getResourceCode());
        currentPermission.setAction(permission.getAction());
        currentPermission.setPermissionCode(permission.getPermissionCode());
