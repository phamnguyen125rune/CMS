    ...
    public void initialize() {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            jdbcTemplate.execute("""
                    ...
                    VALUES
                        (1, 'SUPER_ADMIN', 'Quản trị hệ thống, có toàn quyền', 1, 1),
                        (2, 'ADMIN', 'Quản trị viên, quản lý nghiệp vụ và nhân sự', 1, 0),
                        (3, 'USER', 'Nhân sự sử dụng hệ thống', 1, 0),
                        (4, 'NORMAL_USER', 'Người dùng mặc định, chưa thuộc nhóm quyền nghiệp vụ', 1, 0)
                    """);
