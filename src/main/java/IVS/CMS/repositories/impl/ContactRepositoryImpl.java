...
// public ContactRepositoryImpl(JdbcTemplate jdbcTemplate, ContactRowMapper
// contactRowMapper) {
...
// String sql = "INSERT INTO contacts (name, email, phone, company, service,
...
// @Override
// public List<Contact> findAll(String search, String status, int page, int
// size) {
// StringBuilder sql = new StringBuilder("SELECT * FROM contacts WHERE 1=1");
// List<Object> params = new ArrayList<>();

// if (search != null && !search.trim().isEmpty()) {
// sql.append(" AND (LOWER(name) LIKE ? OR LOWER(email) LIKE ? OR LOWER(subject)
// LIKE ?)");
...
// return jdbcTemplate.query(sql.toString(), contactRowMapper,
// params.toArray());
// }

// @Override
// public long count(String search, String status) {
// StringBuilder sql = new StringBuilder("SELECT COUNT(*) FROM contacts WHERE
// 1=1");
// List<Object> params = new ArrayList<>();
...
// String sql = "UPDATE contacts SET reply_message = ?, status = ?, updated_at =
// ? WHERE id = ?";
// jdbcTemplate.update(sql, replyMessage, status,
